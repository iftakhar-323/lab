...
> Note: The diagram shows the full pull-run-mount-verify sequence. This lab implements each stage in the chapters below.
...
> Note: The screenshot shows additional project images already on this machine. Only the `nginx:latest` row is relevant to this lab.
...
> Note: The screenshot uses host port 50000; the lab examples in this document also use port 50000.
...
![Browser showing the served HTML page at localhost:50000](images/browser-test-result.png)
...
> Note: The screenshot shows the entrypoint configuration, worker process startup, and live access log entries from an actual lab run.
